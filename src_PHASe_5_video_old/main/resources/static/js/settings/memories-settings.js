...
const MemoriesSettings = (function() {
    ...
    async function loadGalleryStats() {
        try {
            ...
            // Only update if elements exist (they were removed from the UI)
            const totalIndexedEl = document.getElementById('totalIndexed');
            const totalPhotosEl = document.getElementById('totalPhotos');
            const totalVideosEl = document.getElementById('totalVideos');
            
            if (totalIndexedEl) {
                totalIndexedEl.textContent = totalIndexed.toLocaleString();
            }
            
            if (totalPhotosEl) {
                totalPhotosEl.textContent = totalIndexed.toLocaleString();
            }
            ...
            const totalIndexedEl = document.getElementById('totalIndexed');
            if (totalIndexedEl) {
                totalIndexedEl.textContent = 'Error';
            }
        }
    }

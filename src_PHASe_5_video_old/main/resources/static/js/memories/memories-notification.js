...
const MemoriesNotificationModule = (function() {
    ...
    function init() {
        ...
        // DISABLED: Don't auto-show notification on page load
        // Users can check calendar badges instead
        // checkForPendingNotification();
        
        // Check every 5 minutes for pending notifications (disabled for now)
